...
<div class="page">
  <b-container class="cart-table-area section-padding-100">
    <b-row>
      <b-col>
        <h3 class="p-2 mt-3 bg-info text-white text-center title">Checkout Page</h3>
      </b-col>
    </b-row>
    <div class="row">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      loading: false,
      successURL: 'https://eshop.com/success',
      
      lineItems: [
        {
          price: 'price_1JSaFkCc0uiepyfR7Nf0tE8Z', // The id of the one-time price you created in your Stripe dashboard
          quantity: 1,
        },
      ],
      shippingInfo: {
