  ...
  <div class="page">
    ...
    <b-container>
      <b-section>
        <b-row>
          <b-col>
            <h3 class="p-2 mt-3 mobilephone-bg bg-dark text-white">Mobile Phones</h3>
          </b-col>
        </b-row>
        <div class="row">
          <div class="col-md-12">
        ...
        <div class="row">
          <b-col class="home-product-background" sm="6" md="3" v-for="(value, index) in products" :key="index">
            <div
              @mouseout="hoverOut()"
              @mouseover="hoverIn()"
              class="animate"
