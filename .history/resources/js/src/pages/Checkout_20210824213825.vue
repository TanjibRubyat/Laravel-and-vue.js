                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    ...
                    <div class="payment-method mb-3">
                      ...
                      <hr>
                      <div class="custom-control custom-radio mr-sm-2" v-for="(paymentmethod,index) in method" :key="index">
                        <input type="radio"  class="custom-control-input" name="payment_method" id="cod" value="cod" v-model="payment_method"/>
