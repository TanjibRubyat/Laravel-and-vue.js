      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-lg-0">
            ...
            <li class="nav-item padding-left pt-1 background">
              <b-dropdown id="dropdown-1" text="Categories" class="m-md-2 background">
                <router-link class="d-block mb-2 bg-info" :to="{ name: 'category-page', params: { id: category.id } }"
          ...
          <ul class="decoration">
            <li>
              <router-link to="#" v-if="$store.getters.isLogin" class="float-right font" v-on:click.native="userLogout">Logout</router-link>
              <router-link v-else class="float-right font" :to="{ name: 'login-page' }">Login</router-link>
            </li>
            <li>
              <router-link
