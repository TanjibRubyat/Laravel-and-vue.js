    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul>
          <li class="decoration">
              <router-link class="float-right decoration"  :to="{name: 'login-page'}">Login</router-link>
          </li>
          <li class="decoration">
               <router-link class="float-right decoration"  :to="{name: 'register-page'}">Register</router-link>
               </li>
               </ul>
          <form class="d-flex">
            <input
