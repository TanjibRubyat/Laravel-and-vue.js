          ...
          <ul class="navbar-nav me-auto mb-lg-0">
            ...
            <li class="nav-item padding-left pt-1">
              <b-dropdown id="dropdown-1" text="Categories" class="m-md-2">
                 <router-link :to="{ name: 'category-page', params: {id: categoryData.id} }"><b-dropdown-item v-for="(category,index) in categories" :key="index">{{category.name}}</b-dropdown-item>
              </b-dropdown>
            </li>
            <li>
              <router-link
