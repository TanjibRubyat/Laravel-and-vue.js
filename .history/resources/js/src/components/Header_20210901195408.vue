      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-lg-0">
            ...
            <li class="nav-item">
              <b-dropdown v-for="(category,index) in categories" :key="index" id="dropdown-1" text="Categories" class="m-md-2">
                 <b-dropdown-item :product-data="category"></b-dropdown-item>
              </b-dropdown>
            </li>
            <li>
              <router-link
