    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-lg-0">
            ...
            <li class="nav-item padding-left pt-1">
              <b-dropdown id="dropdown-1" text="Categories" class="m-md-2">
                 <router-link :to="{ name: 'category-page', params: {id: category.id} }"><b-dropdown-item v-for="(category,index) in categories" :key="index">{{category.name}}</b-dropdown-item></router-link>
              </b-dropdown>
            </li>
            <li>
              <router-link
          ...
          <ul class="decoration">
            <li>
              <router-link class="float-right font" :to="{ name: 'login-page' }"
                >Login</router-link
              >
            </li>
            <li>
